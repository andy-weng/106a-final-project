...
def main():
    ...
    if video_st.average_rate:
        ovstream = output.add_stream('mpeg4', video_st.average_rate)
    else:
        ovstream = output.add_stream('mpeg4', 30) #30 FPS Default
